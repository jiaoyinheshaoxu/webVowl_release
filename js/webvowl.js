...
/***/ (function(module, exports, __webpack_require__) {
	...
	webvowl.modules = {};
	webvowl.modules.colorExternalsSwitch = __webpack_require__(68);
	webvowl.modules.compactNotationSwitch = __webpack_require__(69);
	webvowl.modules.datatypeFilter = __webpack_require__(70);
	webvowl.modules.disjointFilter = __webpack_require__(72);
	webvowl.modules.focuser = __webpack_require__(73);
	webvowl.modules.emptyLiteralFilter = __webpack_require__(74);
	webvowl.modules.nodeDegreeFilter = __webpack_require__(75);
	webvowl.modules.levelFilter = __webpack_require__(76);
	webvowl.modules.nodeScalingSwitch = __webpack_require__(77);
	webvowl.modules.objectPropertyFilter = __webpack_require__(78);
	webvowl.modules.pickAndPin = __webpack_require__(79);
	webvowl.modules.selectionDetailsDisplayer = __webpack_require__(311);
	webvowl.modules.setOperatorFilter = __webpack_require__(312);
	webvowl.modules.statistics = __webpack_require__(313);
	webvowl.modules.subclassFilter = __webpack_require__(314);
		...
		var o = function (graph) {
			...
			this.actualRadius = function () {
				if (!graph.options().scaleNodesByIndividuals() || that.individuals().length <= 0) {
					var MULTIPLIER = 15;
					var level_ = that.level() ? that.level() : 0;
					var additionalRadius = (5 - level_) * MULTIPLIER / 2;
			...
			this.draw = function (parentElement, additionalCssClasses) {
	            ...
	            if (rectangularRepresentation===true) {
	                ...
	                drawTools.appendCircularClass(parentElement, that.actualRadius(), cssClasses, that.labelForCurrentLanguage(), that.backgroundColor(), that.level(), that.comment().goods);
	            }
			...
			function createTextBlock() {
				...
				if(that.comment().goods){
					textBlock.addSubText("优秀率：" + (that.comment().goods*100).toFixed(0) + "%");
				}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
		 ...
		 * @returns {*}
		 */
		tools.appendCircularClass = function (parent, radius, cssClasses, tooltip, backgroundColor, level, goods) {
			// 20181115 如果 goods 为undefined 或者为 "" 或者 null 
			if(!goods){
				var circle = parent.append("circle")
					.attr("r", radius);
			}else{
				var circle = parent.append("circle")
					.classed("class class_circle", true)
					.attr("r", radius);
			}
			...
			switch (level){
				case 1:
					addBackgroundColor(circle, "#f62967");
					// addBackgroundColor(circle, "#79caf6");
					break;
				case 2:
					addBackgroundColor(circle, "#3ab2f8");
						// addBackgroundColor(circle, "#79caf6");
					break;
				case 3:
					addBackgroundColor(circle, "#ffaa53");
					// addBackgroundColor(circle, "#79caf6");
					break;
				case 4:
					addBackgroundColor(circle, "#58d4c1");
					// addBackgroundColor(circle, "#79caf6");
					break;
				case 5:
					addBackgroundColor(circle, "#e16fc0");
					// addBackgroundColor(circle, "#79caf6");
					break;
				default:
	//				addBackgroundColor(circle, "#f62967");
...
/***/ (function(module, exports) {
	...
	module.exports = function () {
		...
		options.defaultConfig=function(){
	        ...
	        defaultOptionsConfig.cd=20;
	        defaultOptionsConfig.dd=100;
	...
	module.exports = function (graph) {
		...
		parser.parseSettings = function () {
			...
			if (settingsData.filter) {
				...
				if (settingsData.filter.levelSliderValue) {
					var levelSliderValue = settingsData.filter.levelSliderValue;
					graph.options().filterMenu().setLevelSliderValue(levelSliderValue);
				}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var elementTools = __webpack_require__(63)();
	var filterTools = __webpack_require__(71)();
...
/***/ (function(module, exports) {
	...
	module.exports = function (menu) {
		...
		filter.initialize = function (nodes, properties) {
			var maxLevel = findMaxLevel(nodes);
			if(maxLevel) {
				if (maxLevelSetter instanceof Function) {
					maxLevelSetter(maxLevel);
				}
	        	menu.setDefaultLevelValue(maxLevel);
			}
		};
	
		function findMaxLevel(nodes) {
			if(!findMax) {
				var maxLevel_ = 0;
				for (var i = 0, l = nodes.length; i < l; i++) {
					maxLevel_ = Math.max(maxLevel_, nodes[i].level());
				}
				findMax = true;
			}
			return maxLevel_;
		...
		filter.filter = function (nodes, properties) {
			var filterP = [];
			var currentLevel = menu.getLevelSliderValue();
	
			for (var i = 0; i < properties.length; i++) {
				var prop = properties[i];
				if(prop.level() < currentLevel) {
					filterP.push(prop);
				}
			}
			var newNodes = [];
			...
			filteredNodes = newNodes;
			filteredProperties = filterP;
		};
	
		filter.setMaxLevelSetter = function (_maxLevelSetter) {
			maxLevelSetter = _maxLevelSetter;
		};
	
		filter.setLevelGetter = function (_levelGetter) {
			levelGetter = _levelGetter;
		};
	
		filter.setLevelSetter = function (_levelSetter) {
			levelSetter = _levelSetter;
		};
		// Functions a filter must have
		filter.filteredNodes = function () {
			return filteredNodes;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var _ = __webpack_require__(80);
	var elementTools = __webpack_require__(63)();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  'chunk': __webpack_require__(81),
	  'compact': __webpack_require__(101),
	  'concat': __webpack_require__(102),
	  'difference': __webpack_require__(110),
	  'differenceBy': __webpack_require__(163),
	  'differenceWith': __webpack_require__(225),
	  'drop': __webpack_require__(226),
	  'dropRight': __webpack_require__(227),
	  'dropRightWhile': __webpack_require__(228),
	  'dropWhile': __webpack_require__(230),
	  'fill': __webpack_require__(231),
	  'findIndex': __webpack_require__(235),
	  'findLastIndex': __webpack_require__(236),
	  'first': __webpack_require__(237),
	  'flatten': __webpack_require__(239),
	  'flattenDeep': __webpack_require__(240),
	  'flattenDepth': __webpack_require__(241),
	  'fromPairs': __webpack_require__(242),
	  'head': __webpack_require__(238),
	  'indexOf': __webpack_require__(243),
	  'initial': __webpack_require__(244),
	  'intersection': __webpack_require__(245),
	  'intersectionBy': __webpack_require__(248),
	  'intersectionWith': __webpack_require__(249),
	  'join': __webpack_require__(250),
	  'last': __webpack_require__(224),
	  'lastIndexOf': __webpack_require__(251),
	  'nth': __webpack_require__(253),
	  'pull': __webpack_require__(255),
	  'pullAll': __webpack_require__(256),
	  'pullAllBy': __webpack_require__(259),
	  'pullAllWith': __webpack_require__(260),
	  'pullAt': __webpack_require__(261),
	  'remove': __webpack_require__(268),
	  'reverse': __webpack_require__(269),
	  'slice': __webpack_require__(270),
	  'sortedIndex': __webpack_require__(271),
	  'sortedIndexBy': __webpack_require__(274),
	  'sortedIndexOf': __webpack_require__(275),
	  'sortedLastIndex': __webpack_require__(276),
	  'sortedLastIndexBy': __webpack_require__(277),
	  'sortedLastIndexOf': __webpack_require__(278),
	  'sortedUniq': __webpack_require__(279),
	  'sortedUniqBy': __webpack_require__(281),
	  'tail': __webpack_require__(282),
	  'take': __webpack_require__(283),
	  'takeRight': __webpack_require__(284),
	  'takeRightWhile': __webpack_require__(285),
	  'takeWhile': __webpack_require__(286),
	  'union': __webpack_require__(287),
	  'unionBy': __webpack_require__(291),
	  'unionWith': __webpack_require__(292),
	  'uniq': __webpack_require__(293),
	  'uniqBy': __webpack_require__(294),
	  'uniqWith': __webpack_require__(295),
	  'unzip': __webpack_require__(296),
	  'unzipWith': __webpack_require__(297),
	  'without': __webpack_require__(298),
	  'xor': __webpack_require__(299),
	  'xorBy': __webpack_require__(301),
	  'xorWith': __webpack_require__(302),
	  'zip': __webpack_require__(303),
	  'zipObject': __webpack_require__(304),
	  'zipObjectDeep': __webpack_require__(308),
	  'zipWith': __webpack_require__(310)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayPush = __webpack_require__(103),
	    baseFlatten = __webpack_require__(104),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseDifference = __webpack_require__(111),
	    baseFlatten = __webpack_require__(104),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseFindIndex = __webpack_require__(146),
	    baseIsNaN = __webpack_require__(147),
	    strictIndexOf = __webpack_require__(148);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var constant = __webpack_require__(159),
	    defineProperty = __webpack_require__(160),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(89),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIsTypedArray = __webpack_require__(193),
	    baseUnary = __webpack_require__(151),
	    nodeUtil = __webpack_require__(194);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(164),
	    baseWhile = __webpack_require__(229);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseFill = __webpack_require__(232),
	    isIterateeCall = __webpack_require__(83);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(150),
	    baseIntersection = __webpack_require__(246),
	    baseRest = __webpack_require__(153),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseFindIndex = __webpack_require__(146),
	    baseIsNaN = __webpack_require__(147),
	    strictLastIndexOf = __webpack_require__(252),
	    toInteger = __webpack_require__(96);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseNth = __webpack_require__(254),
	    toInteger = __webpack_require__(96);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isIndex = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(150),
	    baseIndexOf = __webpack_require__(145),
	    baseIndexOfWith = __webpack_require__(258),
	    baseUnary = __webpack_require__(151),
	    copyArray = __webpack_require__(109);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(164),
	    basePullAll = __webpack_require__(257);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(150),
	    baseAt = __webpack_require__(262),
	    basePullAt = __webpack_require__(263),
	    compareAscending = __webpack_require__(266),
	    flatRest = __webpack_require__(267),
	    isIndex = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseUnset = __webpack_require__(264),
	    isIndex = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var castPath = __webpack_require__(210),
	    last = __webpack_require__(224),
	    parent = __webpack_require__(265),
	    toKey = __webpack_require__(217);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseSortedIndex = __webpack_require__(272);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseSortedIndexBy = __webpack_require__(273),
	    identity = __webpack_require__(154),
	    isSymbol = __webpack_require__(99);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(164),
	    baseSortedIndexBy = __webpack_require__(273);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseSortedUniq = __webpack_require__(280);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(164),
	    baseSortedUniq = __webpack_require__(280);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SetCache = __webpack_require__(112),
	    ...
	    arrayIncludesWith = __webpack_require__(149),
	    cacheHas = __webpack_require__(152),
	    createSet = __webpack_require__(289),
	    setToArray = __webpack_require__(180);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseUniq = __webpack_require__(288);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(185),
	    arrayMap = __webpack_require__(150),
	    baseProperty = __webpack_require__(222),
	    baseTimes = __webpack_require__(189),
	    isArrayLikeObject = __webpack_require__(162);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(185),
	    baseRest = __webpack_require__(153),
	    baseXor = __webpack_require__(300),
	    isArrayLikeObject = __webpack_require__(162);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var assignValue = __webpack_require__(305),
	    baseZipObject = __webpack_require__(307);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var assignValue = __webpack_require__(305),
	    castPath = __webpack_require__(210),
	    isIndex = __webpack_require__(95),
	    isObject = __webpack_require__(93),
	    toKey = __webpack_require__(217);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		...
		var filter = {},
			...
			filteredNodes,
			filteredProperties,
			filterTools = __webpack_require__(71)();
